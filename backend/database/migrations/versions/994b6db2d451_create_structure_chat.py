...
def upgrade():
    ...
    with op.batch_alter_table('conversations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_conversations_user_id'), [
    ...
    with op.batch_alter_table('user_memory', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_memory_user_id'), [
                              'user_id'], unique=False)
    ...
    with op.batch_alter_table('messages', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_messages_conversation_id'), [
