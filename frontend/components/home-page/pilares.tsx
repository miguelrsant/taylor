    ...
    return (
      <div className="pilares">
        <div className="text-pilares">
            <h1 className="text-pilar-taylor">Três pilares para <strong className="text-gradient">transformar</strong> seu negócicio</h1>
            <p className="text-pilar-paragrafo">Uma plataforma completa que une automação, inteligência artificial e análise visual</p>
        </div>
        <div className="cards-pilares">
          <div className="card-pilar">
            ...
            <div className="text-pilar-cards">
              ...
              <p className="text-p-pilar">Envie planilhas Excel/CSV e deixe a IA processar automaticamente. Dados padronizados, integrados e prontos para análise.</p>
            </div>
          ...
          <div className="card-pilar">
            ...
            <div className="text-pilar-cards">
              ...
              <p className="text-p-pilar">Converse com seus dados em linguagem natural. Peça insights, relatórios e análises complexas sem conhecimente técnico.</p>
            </div>
            <div className="tres-vantagens-pilares">
              <div className="vantagem-pilar">
                <div className="bolinha-pilar"></div>
          ...
          <div className="card-pilar">
            ...
            <div className="text-pilar-cards">
              ...
              <p className="text-p-pilar">Painel adptável com visão macro do negócio, KPIs essenciais e açertas automáticos sobre riscos e oportunidades.</p>
            </div>
            <div className="tres-vantagens-pilares">
              <div className="vantagem-pilar">
                <div className="bolinha-pilar"></div>
